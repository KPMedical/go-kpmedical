...
var (
	...
	consoleCommand = &cli.Command{
		...
		Description: `
The Kpm console is an interactive shell for the JavaScript runtime environment
which exposes a node admin interface as well as the Ðapp JavaScript API.
See https://github.com/KPMedical/go-kpmedical/README.md`,
	}
...
which exposes a node admin interface as well as the Ðapp JavaScript API.
See https://github.com/KPMedical/go-kpmedical/README.md
This command allows to open a console on a running kpm node.`,
	}
...
JavaScript API. See https://github.com/KPMedical/go-kpmedical/README.md`,
	}
)

// localConsole starts a new kpm node, attaching a JavaScript console to it at the
// same time.
...
// remoteConsole will connect to a remote kpm instance, attaching a JavaScript
// console to it.
...
// ephemeralConsole starts a new kpm node, attaches an ephemeral JavaScript
