...
import (
	...
	"github.com/KPMedical/go-kpmedical/core/state"
	"github.com/KPMedical/go-kpmedical/core/state/pruner"
	"github.com/KPMedical/go-kpmedical/core/state/snapshot"
	...
	"github.com/KPMedical/go-kpmedical/trie"
		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
kpm snapshot prune-state <state-root>
...
`,
			},
			{
				...
				Description: `
kpm snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
kpm snapshot check-dangling-storage <state-root> traverses the snap storage
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
kpm snapshot inspect-account <address | hash> checks all snapshot layers and prints out
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
kpm snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
kpm snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'kpm dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'kpm dump', but uses the snapshots
