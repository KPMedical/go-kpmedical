...
import (
	...
	"github.com/KPMedical/go-kpmedical/crypto/signify"
	"github.com/KPMedical/go-kpmedical/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/KPMedical/go-kpmedical/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/KPMedical/go-kpmedical/internal/version.gitDate="+env.Date)
	}
